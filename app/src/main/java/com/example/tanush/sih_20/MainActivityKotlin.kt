...
class MainActivityKotlin : AppCompatActivity() {
    ...
    val s="patient name is Pratik Patil. patient ID is 1. take Alpha tablet after lunch for 5 days. diagnosis viral fever. symptom weakness . advice take steam.";
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent1 = Intent(applicationContext, prescription::class.java)
...
//                    .greetUser1("Patient name is kavita sultanpure . Patient id is 1405. Take CEFIZOX 250 mg Injection before lunch after dinner for 2 days. Take Bronkotab EX Tablet after breakfast for 17 days. Take Cefizox 1 mg Injection before dinner for 5 days. Diagnosis 1 viral fever. Symptom 1 Weakness. Symptom 2 Cough. Advice 1 take steam. Advice 2 use warm cloths. stop")
                 .greetUser1("patient name is Pratik Patil. patient ID is 1. take Alpha tablet after lunch for 5 days. diagnosis viral fever. symptom weakness . advice take steam.")
